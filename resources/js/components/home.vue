					...
					<div class="card-body">
						<div class="row align-items-center">
							<div class="col mr-2">
								...
								<!-- Use the computed property for formatting -->
								<div class="h5 mb-0 font-weight-bold text-gray-800">₹{{ formattedIncome }}</div>
...
export default {
	...
	computed: {
		// Computed property to format income with ₹ sign
		formattedIncome() {
			return `₹${this.income}`;
		},
	},
